...
zqry.SQL.Add('insert into pelanggan values(null,"'+edt2.Text+'","'+edt3.Text+'","'+edt4.Text+'","'+edt5.Text+'","'+edt6.Text+'","'+edt7.Text+'")');
zqry.ExecSQL ;
...
zqry.SQL.Clear;
zqry.SQL.Add('Update pelanggan set username= "'+edt2.Text+'",password= "'+edt3.Text+'",nama= "'+edt4.Text+'",alamat= "'+edt5.Text+'",telepon="'+edt6.Text+'",email="'+edt7.Text+'" where id_pelanggan="'+id+'"');
zqry. ExecSQL;
